...
// Sources: ha-bambulab CURRENT_STAGE_IDS / GCODE_STATE_OPTIONS / HMS_SEVERITY_LEVELS / HMS_MODULES,
...
static const StageName STAGE_NAMES[] = {
    ...
    {39, "Bed level phase 1"},
    {40, "Bed level phase 2"},
    {41, "Heating chamber"},
    {42, "Cooling chamber"},
    {43, "Laser calibration"},
    {44, "Nozzle offset calibration"},
    {45, "High temperature auto bed leveling"},
    {46, "Auto bed leveling phase 1"},
    {47, "Auto bed leveling phase 2"},
    {48, "Bed level high-temp phase"},
    {49, "Bed level high-temp phase"},
    {50, "Purging"},
    {51, "Extruder switching"},
    {52, "Heating nozzle"},
    {53, "Preparing AMS"},
    {54, "Toolhead offset calibration"},
    {55, "Filament cutting"},
    {56, "Nozzle wiping"},
    {57, "Filament retracting"},
    {58, "Cutter calibration"},
    {59, "Blade holder calibration"},
    {60, "Bird's-eye camera calibration"},
    {61, "Bird's-eye camera calibration"},
    {62, "Bird's-eye camera calibration"},
    {255, "Idle"},
};
